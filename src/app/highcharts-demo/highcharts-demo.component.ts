...
export class HighchartsDemoComponent implements OnInit {
  ...
  constructor() {
    ...
    this.radarOptions = {
      ...
      xAxis: {
        categories: ['Knowledge', 'Judgement', 'ECG and Arrhythmia', 'Venous Access',
          'Managing the Airway', 'Stroke Management'],
      ...
      series: [{
        ...
        data: [91, 88, 96, 90, 86, 88],
        pointPlacement: 'on',
        color: 'green'
      },
      {
        name: '20th Percentile',
        data: [78, 63, 75, 67, 65, 60],
        pointPlacement: 'on',
        color: 'red'
      },
      {
        name: 'My Scores',
        data: [80, 85, 78, 69, 89, 95],
        pointPlacement: 'on',
        color: 'black'
      }]
    };
